...
public class Eamilapp {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		System.out.println();
		System.out.println("IF YOU WISH TO ACCESS SPECIAL CONTROLS ENTER PASSWORD");
		System.out.println("IF YOU WISH TO SEE THE DETAILS ENTER SHOW");
		
		String p=sc.next();
		if(p.compareTo(em1.getPassword())==0) {
			System.out.println();
